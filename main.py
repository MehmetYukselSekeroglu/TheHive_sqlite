...
DATABASE_CONFIG = ConfigData[1]["database_config"]
...
DB_CNN , DB_CURSOR = database_tools.connection_function(DATABASE_CONFIG)
...
if database_tools.check_db_init_status(*DBS_CONF) == False:
    ...
    DB_CURSOR.executescript(database_structure.DATABASE_STRUCTURE_SQLITE)
